...
export type Language = "ru" | "chm" | "sah" | "tyv" | "en";
...
export const TRANSLATIONS: Record<Language, TranslationStrings> = {
  ru: {
    ...
    savePng: "Экспорт PDF",
    downloadPdf: "Скачать полный PDF отчет",
    ...
    careerPlanSavePngBtn: "Экспорт плана (PDF)",
    strategyGrowth: "РОСТ",
  ...
  chm: {
    title: "Карьер компас",
    subtitle: "Карьер баланс орава • Интерактив карьер аудит",
    heroTitle: "Паша илышын балансым висыза",
    heroSubtitle: "Шке карьер оравам чоҥыза, тӱҥ шорт-влаклан 1 гыч 10 марте баллым шындалыза, паша планым возыза да ямдылык PDF-отчетым налыза.",
    clientApp: "100% клиент веб-аппликаций",
    guestMode: "⚠️ Уна режим",
    loginRegister: "Пураш / Регистраций",
    userLabel: "Пайдаланыше",
    logoutLabel: "Лекташ",
    interactiveWheel: "Интерактив орава",
    interactiveWheelDesc: "Критерийын баллым вашталташ манын, орава сегментыш темдалза",
    ...
    wheelTitleLabel: "Ораван лӱмжӧ (висымаш)",
    ...
    addCustomLabel: "Шке критерийым ушнаш",
    addCustomPlaceholder: "Мутлан: Чытымашлык",
    addButton: "Ушнаш",
    editCriteriaHeader: "Критерий-влакым тӧрлатымаш",
    clearAll: "Чыла эрыкташ",
    emptyListWarning: "Список яра. Кӱшнӧ шаблон-влакым ойырыза але шке паша сфер-влакым ушныза!",
    notesPlaceholder: "Пале-влак: Модлан кӧра 10 балл огыл? Могай ошкыл-влакым ышташ палемдыза?",
    saveWheelButton: "Оравам историйыш аралаш",
    guestWarningInEditor: "⚠️ Тый авторизацийым эртышын огытыл. Аралыме орава тиде компьютерыште гына кодеш. Историйлан эре лекташ манын, регистрацийым эртыза!",
    ...
    coachTipDesc: "Орава йӧнын кая, кунам тудо йыргешке. Чыла сферлаште 7-8 баллаш идеально сбалансированный орава эн кугу куан ышта, пашаште 10-ан гыч канышыште 2-ан марте тӧрштылмо деч. Колалатым лап куатлатым тӧрлаташ тыршыза.",
    ...
    historyEmptyDesc: "Редакторыште кнопко дене шке замер-влакым аралыза, нуно тиде верыште таҥастараш да анализлан лектыт!",
    avgScoreLabel: "кыдалаш балл",
    compareBtn: "Таҥастараш",
    openBtn: "Почаш",
    spheresCount: "сфер",
    footerCopy1: "© 2026 Карьер компас (Карьер баланс орава). Чыла правам аралыме.",
    ...
    authDescLogin: "Шке карьер орава-влакым аралаш да таҥастараш манын, пурыза",
    ...
    // New translations: Color settings
    colorSettingsHeader: "Ораван тӱс тӧрлатымаш",
    colorModeLabel: "Ораван тӱс режимже:",
    ...
    careerPlanTitle: "Шке карьер кушмо план",
    ...
    careerPlanAdviceText: "Ямдылык каҥашым налаш манын, «Ошкыл-влакым возаш» кнопкалан темдалза, а вара шке илыш дене тӧрлатыза. Экспорт годым чыла палемдымаш-влак аралалтыт!",
  ...
  tyv: {
    title: "Карьер Компас",
    subtitle: "Карьер теңнелинниң дескинчигежи • Профессионал аудит",
    heroTitle: "Силерниң профессионал чуртталгаңарның деңнелин түңнеңер",
    heroSubtitle: "Индивидуалдыг карьер дескинчигешин чогаадып, кол адырларга 1-ден 10 чедир демдектерни салыңар, ажыл-айнык планын тургузуп, PDF илеткелди кииргизип ап болур силер.",
    clientApp: "100% клиент веб-эптиг программа",
    guestMode: "⚠️ Аалчы хевири",
    loginRegister: "Кирери / Бүртгедир",
    userLabel: "Ажыглакчы",
    logoutLabel: "Үнери",
    interactiveWheel: "Интерактив дескинчигеш",
    interactiveWheelDesc: "Критерий демдээн өскертирде дескинчигештиң кезенээн басыңар",
    savePng: "Экспорт PDF",
    downloadPdf: "Бүтүн PDF илеткелди киирип алыр",
    averageLabel: "Ортаа",
    outOfTen: "10 демдектен",
    comparisonWith: "Деңнелге көргүскен:",
    prevMeasurement: "Мурнундагы хемчээшкин",
    wheelTitleLabel: "Дескинчигеш ады",
    wheelTitlePlaceholder: "Дескинчигеш адын киириңер...",
    templateHeader: "Белен шаблоннар:",
    templateClassic: "Классик карьер",
    templateBusiness: "Бизнес удуртулгазы",
    templateFreelance: "Фриланс / Бот-ажыл",
    addCustomLabel: "Чаа сфера негээри",
    addCustomPlaceholder: "Чижээ: Даштыкы дылдар...",
    addButton: "Негээр",
    editCriteriaHeader: "Сфераларны эдилээри угаан:",
    clearAll: "Шуптузун арыглаар",
    emptyListWarning: "Сфералар чок. Уланчылаарда шаблонну шилиңер азы бодуңар негеңер.",
    notesPlaceholder: "Дептер: 10 чедип алырынга чүү шаптыктап турарыл? Кандыг базымнарны кылыр силер?",
    saveWheelButton: "Дескинчигешти төөгүге баттырар",
    guestWarningInEditor: "⚠️ Силер кирбээн силер. Баттырган дескинчигештер чүгле бо браузерге арттар. Төөгүңер сонуургаар болзуңарза бүртгедип алыңар!",
    howToReadHeader: "Түңнелдерни канчаар билип алырыл?",
    zoneCritical: "1 - 3 демдектер (Критикалыг булуң)",
    zoneCriticalDesc: "Адыр дыка соонда калган азы стресс үндүрүп турар. Дүрген өскертиглер ужурлуг.",
    zoneRoutine: "4 - 6 демдектер (Хүнбүрүде чаңчыл)",
    zoneRoutineDesc: "Ортаа деңнел. Эптиг, ыччып турар чүүл чок. Дүрген туран киирип болур.",
    zoneComfort: "7 - 8 демдектер (Комфорт булуңу)",
    zoneComfortDesc: "Өндүр деңнел! Бурунгаар сайзырал, бедик сонуургал. Бо адырны чагырып турар силер.",
    zonePeak: "9 - 10 демдектер (Бедик суур)",
    zonePeakDesc: "Идеалдыг деңнел. Долу ханныкшыл. Бо критерий силерниң кол тирээңер.",
    coachTipHeader: "Коучтуң сүмези:",
    coachTipDesc: "Дескинчигеш ТӨГҮРҮК болза, эки дескинер. Шупту адырларга 7-8 демдектер турары, ажылга 10 удурланыштыр кадыкшылга 2 турарга караганда хөй өөрүшкүнү эккээр.",
    historyHeader: "Хемчээшкиннер төөгүзү",
    historyDesc: "Мурнундагы түңнелдерни киирип, деңнеп көрүңер",
    historyEmptyTitle: "Төөгү куруг",
    historyEmptyDesc: "Дескинчигешти баттырып, мында деңнелге кылыңар!",
    avgScoreLabel: "ортаа демдек",
    compareBtn: "Деңнээр",
    openBtn: "Ажыдар",
    spheresCount: "сфералар",
    footerCopy1: "© 2026 Career Compass (Карьер теңнелинниң дескинчигежи). Шупту эргелер камгалатткан.",
    footerCopy2: "Программа силерниң херекселиңерге чажыт кылдыр бот-ажылдап турар.",
    toastSaved: "Хемчээшкин төөгүге баттырттынган!",
    toastDeleted: "Хемчээшкин төөгүден казыттынган",
    toastLoaded: "Хемчээшкин ажыттынган",
    historyChartTitle: "Карьер теңнелинин динамиказы (Ортаа демдек)",

    authTitleLogin: "Кирери",
    authTitleRegister: "Бүртгедири",
    authDescLogin: "Карьер дескинчигештериңерни баттырып, деңнээр дээш кириңер",
    authDescRegister: "Профессионал өзелиңерни шинчилеп тургаш, аккаунт чогаадып алыңар",
    authUsernameLabel: "Ажыглакчы ады",
    authUsernamePlaceholder: "Ажыглакчы",
    authPasswordLabel: "Пароль",
    authPasswordPlaceholder: "••••••••",
    authLoginBtn: "Кирери",
    authRegisterBtn: "Аккаунт чогаадыр",
    authNoAccount: "Аккаунтуңар чок бе?",
    authHaveAccount: "Аккаунтуңар бар бе?",
    authRegisterLink: "Ам бүртгедир",
    authLoginLink: "Кирери",
    authOr: "Азы",
    authContinueGuest: "Аалчы хевиринден уланчылаар (Бүртгел чок)",
    authGuestWarning: "Аалчы хевиринде түңнелдер бо браузерге гана баттырттынар.",
    authEmptyFieldsErr: "Шупту булуңнарны долуңар.",
    authNotFoundErr: "Мындыг ажыглакчы тыппасды.",
    authWrongPassErr: "Тааржыр эвес пароль.",
    authSuccessLogin: "Оюнга кирип келдиңер! Чүктелде...",
    authExistsErr: "Бо ажыглакчы ады эжеп алдынган.",
    authSuccessRegister: "Бүртгел четишкен! Киирилде...",

    themeLabel: "Тема",
    themeDark: "Кара",
    themeLight: "Ярык",

    colorSettingsHeader: "Дескинчигеш өңнери",
    colorModeLabel: "Дескинчигеш өңнерин шилиири:",
    colorModePalette: "Критерий аайы-биле (Палитра)",
    colorModeScores: "Демдектер аайы-биле (Булуң өңнери)",
    colorCustomizerHeader: "Булуң өңнери:",
    colorResetBtn: "Өңнерни солуар",
    colorModeDesc: "Демдектер аайы-биле хевирге өңнер 1-3, 4-6, 7-8, 9-10 демдектерге тааржыр.",
    colorActivePaletteLabel: "Өңнерни эдип солуары",
    careerPlanTitle: "Карьер сайзыралының индивидуалыг планы",
    careerPlanDesc: "Сорулга демдектерин салып, сорулга базымнарын тургузуңар.",
    careerPlanEmpty: "План тургузарда удуртур сфераларны негеңер!",
    careerPlanSetTarget: "Сорулга деңнелин салыңар (1-10)",
    careerPlanAutoGen: "Планны авто-чогаадыр",
    careerPlanStepsHeader: "Чедип алыр базымнар",
    careerPlanSummaryHeader: "Ниити план",
    careerPlanMatrixTitle: "Активтиг сорулгалар матрицазы",
    careerPlanNoSteps: "Базымнар амдан чок",
    careerPlanStepsActive: "активтиг базымнар",
    careerPlanAdviceHeader: "Коуч сүмези",
    careerPlanAdviceText: "Коуч канаштарын алырда «Базымнарны чогаадыр» кнопканы басыңар. PDF кылдыр киирип алырга шупту планнар негеттинер!",
    careerPlanSavePngBtn: "Планны экспортоор (PDF)",
    strategyGrowth: "ӨЗЕЛ",
    strategyOptimization: "ОПТИМИЗАЦИЯ",
    strategyMaintain: "ДЕМДЕКТЕП АЛЫР",
  },
  en: {
...
export const TEMPLATES_BY_LANG: Record<Language, {
  ...
  tyv: {
    standard: [
      { name: "Профессионал өзел", score: 5, notes: "" },
      { name: "Ажыл шалыңы да бонустар", score: 5, notes: "" },
      { name: "Ажыл да чуртталга теңнели", score: 5, notes: "" },
      { name: "Кады ажылдаксатчылар-биле харылзаа", score: 5, notes: "" },
      { name: "Ажылга сонуургал", score: 5, notes: "" },
      { name: "Ажыл шарттары", score: 5, notes: "" },
      { name: "Удуртулганың үнелели", score: 5, notes: "" },
      { name: "Өөредилге да сайзырал", score: 5, notes: "" },
    ],
    business: [
      { name: "Компания орулгазы", score: 5, notes: "" },
      { name: "Аралажылга да маркетинг", score: 5, notes: "" },
      { name: "Процесстер автоматизациязы", score: 5, notes: "" },
      { name: "Команда күчүзү да мотивациязы", score: 5, notes: "" },
      { name: "Продукт конкурециязы", score: 5, notes: "" },
      { name: "Стратегия көрүүшүк", score: 5, notes: "" },
      { name: "Бренд билдингири", score: 5, notes: "" },
      { name: "Клиенттер ханныкшылы", score: 5, notes: "" },
    ],
    freelance: [
      { name: "Допчу орулга агымы", score: 5, notes: "" },
      { name: "Желеде бот-бренд", score: 5, notes: "" },
      { name: "Портфолио шынары", score: 5, notes: "" },
      { name: "Клиенттер деңнели да харам чок чоруу", score: 5, notes: "" },
      { name: "График хостуу", score: 5, notes: "" },
      { name: "Бот-дисциплина", score: 5, notes: "" },
      { name: "Ажыл олуду эптиг чоруу", score: 5, notes: "" },
      { name: "Нетворкинг да харылзаалар", score: 5, notes: "" },
    ]
  },
  en: {
    standard: [
